...
public class FrenchRevenueTaxCalculator {
    ...
    public static void main(String[] args) {
        ...
        //CORRECTON Suppresion else dans les if et else if(aucun intérêt)
        ...
        // Si le salaire est compris entre 177 105 € et 82 342 €
            ...
            System.out.println(bareme2);
            System.out.println(bareme1);
            String affichageTotal = ("Le total de vos impôts à nous régler est de " + totalIr + " € (" + irTrd + " à 40% , " + irScdClass + " à 30 % , " + irFirstClass + " à 11 %). " );

            // Cas Particulier égalité
            if (salary == lastClassCap) {

                double totalIrEquals = irTrdClass + irScdClass + irFirstClass;
                System.out.println(tranche3);
                System.out.println(bareme3);
                System.out.println(bareme2);
                System.out.println(bareme1);
                System.out.println("Le total de vos impôts à nous régler est de " + totalIrEquals + " € (" + irTrdClass + " à 40% , " + irScdClass + " à 30 % , " + irFirstClass + " à 11 %). ");
            }
        ...
        // Si le salaire est compris entre 82 342 € et 28 798 €
            ...
            if (salary == thrirdClassCap) {
                double totalIrEquals = irScdClass + irFirstClass;
                System.out.println(tranche2);
                System.out.println(bareme2);
                System.out.println(bareme1);
                System.out.println("Le total de vos impôts à nous régler est de " + totalIrEquals + " € (" + irScdClass + " à 30 % , " + irFirstClass + " à 11 %). ");
            }
        ...
        // Si le salaire est compris entre 28 798 € et 11 294 €
            ...
            System.out.println("Le total de vos impôts à nous régler est de " + totalIr + " €.");
                ...
                if (salary == secondClassCap) {
                    double totalIrEquals = irFirstClass;
                    System.out.println(bareme1);
                    System.out.println(bareme2);
                    System.out.println("Le total de vos impôts à nous régler est de " + totalIrEquals + " €.");
                }
