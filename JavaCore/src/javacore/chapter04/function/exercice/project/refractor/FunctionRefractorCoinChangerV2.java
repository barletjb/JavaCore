...
public class FunctionRefractorCoinChangerV2 {
        ...
        public static void main(String[] args) {
            ...
            // Condition en cascade avec % et /
                ...
                if (requiredOf50 > 0) {
                    ...
                    displayBills(EUR_50, requiredOf50);
                }
                ...
                if (requiredOf20 > 0) {
                    ...
                    displayBills(EUR_20, requiredOf20);
                }
                ...
                if (requiredOf10 > 0) {
                    ...
                    displayBills(EUR_10, requiredOf10);
                }
               ...
               // Combien de billet(s) de 5
                ...
                if (requiredOf5 > 0) {
                    ...
                    displayBills(EUR_5, requiredOf5);
                }
                ...
                if (requiredOf2 > 0) {
                    ...
                    displayCoins(EUR_2, requiredOf2);
                }
                ...
                if (requiredOf1 > 0) {
                    ...
                    displayCoins(EUR_1, requiredOf1);
                }
    ...
    /**
     * Displays the number of banknotes of a specific value returned to the user.
     * @param eur        the face value of the banknote in euros.
     * @param requiredOf the number of banknotes of that value to display.
     */
        public static void displayBills(int eur, int requiredOf){
            System.out.println("Le nombre de billet(s) de " + eur + " € rendu est de : " + requiredOf);
        }

    /**
     * Displays the number of coins of a specific value returned to the user.
     * @param eur        the face value of the banknote in euros.
     * @param requiredOf the number of banknotes of that value to display.
     */
    public static void displayCoins(int eur, int requiredOf) {
            System.out.println("Le nombre de piece(s) de " + eur + " € rendu est de : " + requiredOf);
        }
    }
